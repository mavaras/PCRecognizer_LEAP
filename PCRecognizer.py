...
=======
    ...
    class Extra():
        ...
        def get_conf(self):
            ...
            return aux
>>>>>>> 2dd33195896772b58329496c8488daa1d447d34b
...
class MainWindow(QtGui.QMainWindow, Ui_MainWindow):
	...
	def initUI(self):
		...
		self.combo_box_click.currentIndexChanged["int"].connect(lambda: self.combo_box_actiongesture_changed(self.combo_box_click))
		self.cb_action_gesture[self.combo_box_click] = {0:"click_plane", 1:"click_deep"}
		self.combo_box_rclick.currentIndexChanged["int"].connect(lambda: self.combo_box_actiongesture_changed(self.combo_box_rclick))
		self.cb_action_gesture[self.combo_box_rclick] = {0:"rclick_plane", 1:"rclick_deep"}
		self.combo_box_minimizew.currentIndexChanged["int"].connect(lambda: self.combo_box_actiongesture_changed(self.combo_box_minimizew))
		self.cb_action_gesture[self.combo_box_minimizew] = {0:"minimize_1", 1:"minimize_2"}
		self.combo_box_closew.currentIndexChanged["int"].connect(lambda: self.combo_box_actiongesture_changed(self.combo_box_closew))
		self.cb_action_gesture[self.combo_box_closew] = {0:"closew_1", 1:"closew_2"}
		
		# help buttons
		self.set_gesture_gif("gifs/no_gesture.gif")
	...
	def view_gesture(self, combo_box):
		...
		self.set_gesture_gif("gifs/"+str(self.cb_action_gesture.get(combo_box).get(combo_box.currentIndex()))+".gif")
		self.label_gesture_gif.setLayout(QtGui.QHBoxLayout())
